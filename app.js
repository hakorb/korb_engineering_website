...
const SECTIONS = {
  ...
  misc: {
    ...
    tools: [
      ...
      { name: 'Geometry Wars', file: './tools/misc/geometry-wars.html' },
...
const TOOL_DESCRIPTIONS = {
  ...
  'Geometry Wars': 'Neon twin-stick shooter. Survive waves of geometric foes with bombs, multipliers, and gravity wells.',
