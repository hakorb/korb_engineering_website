...
const SECTIONS = {
  aviation: {
    ...
    tools: [
      ...
      { name: 'Airfield Marking Takeoff', file: './tools/aviation/airfield-marking-takeoff.html' },
      { name: 'ARFF Index Calculator', file: './tools/aviation/arff-index-calculator.html' },
      ...
      { name: 'ASCE 7 Wind Load', file: './tools/civil/asce7-wind-load.html' },
      ...
      { name: 'AIP Funding Calculator', file: './tools/aviation/aip-funding-calculator.html' },
      { name: 'DFW Pavement & Grounds 30-Day', file: './tools/aviation/dfw-pavement-grounds-30-day.html' },
      ...
      { name: 'Flight Replay HUD', file: './tools/aviation/flight-replay-hud.html' },
      ...
      { name: 'Free Body Diagram', file: './tools/civil/free-body-diagram.html' },
      { name: 'FE/PE Practice', file: './tools/civil/fe-pe-practice.html' },
      { name: 'Geotech Investigation RFP', file: './tools/aviation/geotech-rfp-tool.html' },
      { name: 'GIS Layer Streamer', file: './tools/aviation/gis-layer-streamer.html' },
      { name: 'Glenn Riddle Scheduler', file: './tools/aviation/glenn-riddle-scheduler.html' },
      ...
      { name: 'ITE Trip Generation', file: './tools/civil/ite-trip-generation.html' },
      ...
      { name: 'NFPA 13 Sprinkler Hydraulic', file: './tools/civil/nfpa13-sprinkler-hydraulic.html' },
      ...
      { name: 'Pavement Crack Detector', file: './tools/aviation/pavement-crack-detector.html' },
      ...
      { name: 'PAPI Spotting Tool', file: './tools/aviation/papi-spotting-tool.html' },
      ...
      { name: 'People Watching Bingo', file: './tools/misc/people-watching-bingo.html' },
      ...
      { name: 'Point Cloud Viewer', file: './tools/aviation/point-cloud-viewer.html' },
      ...
      { name: 'AASHTO Sight Distance', file: './tools/civil/aashto-sight-distance.html' },
      ...
      { name: 'Which FAA Form Wizard', file: './tools/aviation/which-faa-form.html' },
  ...
  civil: {
    ...
    tools: [
      ...
      { name: 'Concrete Pour Planner', file: './tools/civil/concrete-pour-planner.html' },
      ...
      { name: 'FOIA Request Generator', file: './tools/misc/foia-request-generator.html' },
      { name: 'Footing Bearing Capacity', file: './tools/civil/footing-bearing-capacity.html' },
      ...
      { name: 'Korb Engineering Console', file: './tools/civil/korb-engineering.html' },
      ...
      { name: 'Manning\'s Open Channel', file: './tools/civil/mannings-open-channel.html' },
      ...
      { name: 'Refugee Legal Counsel', file: './tools/civil/refugee-legal-counsel.html' },
      ...
      { name: 'Section Property Calculator', file: './tools/civil/section-property-calculator.html' },
      ...
      { name: 'Source Cited', file: './tools/civil/source-cited.html' },
      ...
      { name: 'Stationing Helper', file: './tools/civil/stationing-helper.html' },
      ...
      { name: 'Traverse Adjustment', file: './tools/civil/traverse-adjustment.html' },
      ...
      { name: 'Whiteboard', file: './tools/civil/whiteboard.html' }
    ]
  },
  hk: {
    title: 'HK',
    ...
    tools: [
      { name: 'Biometric Vault', file: './tools/hk/biometric-vault.html' },
      ...
      { name: 'Site Health Dashboard', file: './tools/hk/site-health-dashboard.html' },
  ...
  misc: {
    ...
    tools: [
      ...
      { name: 'Bill Splitter', file: './tools/misc/bill-splitter.html' },
      { name: "Blake's Travel Plan", file: './tools/misc/blakes-travel-plan.html' },
      { name: 'Build Your Own Korb Site', file: './tools/misc/build-your-own-korb-site.html' },
      { name: 'Bumper Pool', file: './tools/misc/bumper-pool.html' },
      { name: 'Catan (Settlers of Korb)', file: './tools/misc/catan.html' },
      ...
      { name: 'Data Broker Opt-Out', file: './tools/misc/data-broker-optout.html' },
      ...
      { name: 'EULA Red-Flag Scanner', file: './tools/misc/eula-red-flag-scanner.html' },
      ...
      { name: 'Freelancer Rate Calculator', file: './tools/misc/freelancer-rate-calculator.html' },
      ...
      { name: 'Euclidean-Wars', file: './tools/misc/geometry-wars.html' },
      ...
      { name: 'Moving Day Planner', file: './tools/misc/moving-day-planner.html' },
      ...
      { name: 'Target Arena', file: './tools/misc/nerf-arcade.html' },
      ...
      { name: 'Open When IT Happens', file: './tools/misc/open-when-it-happens.html' },
      ...
      { name: 'Photo Album', file: './tools/misc/photo-album.html' },
      ...
      { name: 'Privacy Policy Diff', file: './tools/misc/privacy-policy-diff.html' },
      { name: 'Recipe Cost Calculator', file: './tools/misc/recipe-cost-calculator.html' },
      ...
      { name: 'Serendipity Feed', file: './tools/misc/serendipity-engine.html' },
      { name: 'Simon', file: './tools/misc/simon.html' },
      { name: 'Small Claims Letter', file: './tools/misc/small-claims-letter.html' },
      ...
      { name: 'Tool Request', file: './tools/misc/tool-request.html' },
...
const TOOL_DESCRIPTIONS = {
  ...
  'Airfield Marking Takeoff': 'Compute FAA-spec marking quantities (paint, beads, primer) and pavement tonnage/volume, then roll up into a bid-item table.',
  ...
  'Pavement Crack Detector': 'Upload a pavement photo or orthomosaic. Edge-detection + morphology extracts cracks, reports total length and density, exports overlay/GeoJSON/PDF. Optional ONNX model slot for AI inference.',
  ...
  'Concrete Pour Planner': 'Plan pour day: truck count, arrival interval, crew size, ASTM C94 90-min check, finish window, and printable pour ticket.',
  ...
  'Section Property Calculator': 'Compute A, I, S, Z, r, J, Cw for rectangular/circular/pipe/HSS/I/T/L/C shapes with live SVG and integrated beam shear/moment/deflection solver, Mohr\u2019s circle, and AISC wide-flange lookup.',
  ...
  'Source Cited': 'Paste a URL \u2192 auto-extracts title, author, date, and site from OpenGraph/JSON-LD \u2192 formats a clean citation in APA / MLA / Chicago / IEEE / Harvard. Build a library, copy-paste individual citations, or export the whole thing as a polished references PDF.',
  ...
  'Stationing Helper': 'Civil-survey stationing calculator: parse STA 12+34.56 notation, build horizontal alignments with PC/PT/PI/T/L/LC/E/M/D, design parabolic vertical curves with K-values and HP/LP detection, slope-stake offsets, bearing/azimuth arithmetic, and batch CSV export. Ft and metric.',
  ...
  'ARFF Index Calculator': 'FAA Part 139.315/.317/.319 ARFF index calculator. Enter longest aircraft + avg daily departures, get Index A-E with required equipment and agent quantities.',
  'ASCE 7 Wind Load': 'ASCE 7-22 wind load calculator (directional procedure, Ch 27). MWFRS + C&C pressures, visualized diagram, engineer-review disclaimer.',
  'DFW Pavement & Grounds 30-Day': 'Onboarding playbook for a new pavement & grounds manager at DFW. 30 days of tasks, pitfalls, and Part 139 references. Progress tracked per task.',
  'ITE Trip Generation': 'ITE 11th Edition trip generation estimator for 35 common land use codes. Daily, AM + PM peak, pass-by reduction, internal capture. Print-ready TIS summary.',
  'Bill Splitter': 'Universal bill splitter with per-item assignment, tax, tip, fees. Venmo/PayPal/Cash App deep-link generator. No signup.',
  'Data Broker Opt-Out': '51-broker guided opt-out walkthrough with status tracking, 30-day reminder flag, CSV + JSON export. No data collection on our end.',
  'AASHTO Sight Distance': 'Stopping, passing, decision, and intersection sight distance per AASHTO Green Book 7th Ed. Grade correction, SVG diagrams.',
  'Manning\'s Open Channel': 'HEC-RAS-lite open-channel flow: rectangular, trapezoidal, triangular, circular, parabolic. Solve for Q/y/S/n. Critical depth, Froude, rating curve.',
  'Refugee Legal Counsel': 'Free informational resource for refugees/asylum-seekers: processes, forms, rights, 24+ legal-aid org directory, private intake-notes form. Not legal advice.',
  'FOIA Request Generator': 'Federal FOIA + all 50 state open-records laws. Agency picker, fee waiver, expedited processing, PDF/.txt/.eml export, status tracker.',
  'Small Claims Letter': 'Small-claims demand letter + notice + filing checklist for all 50 states + DC. SOL warning engine. PDF export.',
  'Traverse Adjustment': 'Land surveying closed/open traverse with compass (Bowditch), transit, and least-squares adjustments side-by-side. Precision verdict + SVG plot + CAD-ready CSV export.',
  "Blake's Travel Plan": 'Streamlined trip itinerary builder with day-by-day events, packing list, contacts, and polished PDF export.',
  ...
  'Neon Grid': 'Neon twin-stick shooter with high-tempo synthesized soundtrack, collectible crystals from defeated foes, bombs, multipliers, bosses, and a Pacifist mode where you can\'t shoot \u2014 only dodge and collect. Gamepad supported.',
  ...
  "Kyle's Train Set": 'Drivable train simulator with stations and cargo, PLUS a grid track builder and run-mode for watching trains loop your custom layouts.',
  ...
  "Brigette's Funding Sheet": 'Web version of the monthly reimbursement funding sheet: bid items, pay apps, rounding-QC checks, and color-coded funding-source splits with print-ready export.',
  ...
  'Situation Monitor': 'Command-center style multi-panel dashboard with news, weather, alert feeds, teletype log, CRT overlay, and amber HUD readouts.',
  'Site Health Dashboard': 'Real-time health and activity monitor for korb.engineering \u2014 GitHub commits, deploy status, tool inventory, uptime, category breakdown, browser diagnostics, and a live log feed.',
  'Biometric Vault': 'Unlock the HK section with TouchID, FaceID, or Windows Hello via WebAuthn. Multi-device credentials stored locally in the device secure enclave; password fallback preserved.',
  'Flight Replay HUD': 'Upload GPX / KML / DJI drone logs and replay the flight with a retro HUD: altimeter tape, compass ribbon, attitude, VSI, and synchronized map.',
  'GIS Layer Streamer': 'Browse and overlay public WMS / WMTS / XYZ tile layers on Leaflet. Federal, Texas, aviation, environmental catalogs plus custom-layer paste.',
  'Glenn Riddle Scheduler': 'Staff scheduling + workload balancer. Ranks employees by hours worked in any date window, auto-suggests best candidate for new shifts (lowest hours, not on leave), tracks vacation/sick/holiday, weekly calendar grid, CSV + JSON exports.',
  ...
  'Target Arena': 'Moving-target blaster. Tap to fire darts at red/blue/green/gold targets for points — dodge the penalty skulls. 60-second rounds. Gamepad supported.',
  ...
  'Korb Engineering Console': 'GitHub-styled construction project console with rich documentation and project-phase tracking.',
  'Legends of the Hidden Temple': 'Pick a team, cross Olmec\'s moat, climb the Steps of Knowledge, then race through the temple rooms to retrieve the artifact before time runs out.',
  'Constraint Optimizer': 'Set up decision problems with hard constraints and preferences; get ranked solution paths.',
  'Content Calendar': 'Plan and schedule content across channels with a visual month grid and drafts.',
  'Decision Journal': 'Capture decisions with rationale, risks, and expected outcomes; review with hindsight later.',
  'Financial Planner': 'Personal-finance scenarios for savings, retirement, and major-purchase trade-offs.',
  'Gift Finder': 'Gift ideas driven by recipient profile, occasion, and budget.',
  'Meeting Adversary': 'Devil\'s-advocate simulator that challenges proposals before the real meeting.',
  'Negotiation Simulator': 'Practice negotiation conversations with AI-style counterparts and tactic feedback.',
  'Pre-mortem Generator': 'Imagine how a project fails before it starts. Mitigation checklists included.',
  'QA/QC Checklist': 'Quality-control checklists for deliverable review with per-discipline items.',
  'Relationship Tracker': 'Keep track of people you care about \u2014 last-contact, shared interests, gift history.',
  'Scenario Modeler': 'Branching \"what if\" scenarios with weighted probabilities and outcomes.',
  'Section Property Calculator': 'Free beam section property calculator \u2014 moment of inertia, section modulus, plastic Z, torsion J, plus a shear/moment/deflection solver and AISC W-shape lookup.',
  'Shopping Decision Engine': 'Tradeoff matrix for comparing big purchases across features, price, and reliability.',
  'Smart Home': 'Plan a DIY smart-home automation without locking into one ecosystem.',
